...
// Hint: Your password must be at least 8 characters long, include 1 special character, 1 number, 1 uppercase and 1 lowercase letter.
defaultOptions.ui.errorMessages = {
    ...
    wordLowercase: "Missing: Lowercase character",
    wordUppercase: "Missing: Uppercase character",
    wordOneNumber: "Missing: Number",
    wordOneSpecialChar: "Missing: Special character (@, %, &, etc)"
};
...
(function ($, ui) {
    ...
    ui.initErrorList = function (options, $el) {
        ui.initHelper(options, $el, "<div class='alert-danger' style='border-radius: 4px;'><ul class='error-list' style=''></ul></div>",
